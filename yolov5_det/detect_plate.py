...
if __name__ == '__main__':
    ...
    parser.add_argument('--detect_model', nargs='+', type=str, default='/home/zsh/cvpro/Chinese_license_plate_detection_recognition-main/runs/train/exp9/weights/best.pt', help='model.pt path(s)')  #检测模型
    ...
    roi_img=cv2.imread("imgs/1-1.jpg")
    plate_number,rec_prob,plate_color,color_conf = get_plate_result(roi_img,device,plate_rec_model,is_color=opt.is_color)  
    print(plate_number)
